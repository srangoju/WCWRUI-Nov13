class Knos {
    constructor() {
        ...
        this.caseType = element(by.cssContainingText('option', 'Case Type123'));
        //this.caseSubType = element(by.cssContainingText('option', 'Class Action'));
        this.caseSubType = element(by.xpath("/html/body/app-root/div/div/div[2]/app-knos/div/div/div[2]/div/div[1]/app-search-template[2]/div/div/div[1]/div[2]/select/option[3]"));
        ...
        this.relationships=element(by.xpath("/html/body/app-root/div/div/div[2]/app-courts/div/div/div[2]/div/app-create-court/div/div/div[1]/div[2]/div[2]/app-search-template/div/div/div/button"));
        ...
        this.cancelButton = element(by.xpath("/html/body/app-root/div/div/div[2]/app-knos/div/div/div[2]/div/div[2]/app-search-template/div[1]/div/button/span"));
